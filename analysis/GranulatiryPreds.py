...
from vgg16_train import ColorizationCNN

# Configuration

SHARD_DIR       = _PROJECT_ROOT / "data" / "coco" / "train2017_cache_256_mmap"
UNET_MODEL_PATH = str(_PROJECT_ROOT / "data" / "models" / "unet_colorizer_best.pt")
VGG_MODEL_PATH  = str(_PROJECT_ROOT / "data" / "models" / "cnn_colorizer_best.pt")
...
def main():
    ...
    try:
        vgg = ColorizationCNN(pretrained_backbone=False)
        checkpoint = torch.load(VGG_MODEL_PATH, map_location=DEVICE)
