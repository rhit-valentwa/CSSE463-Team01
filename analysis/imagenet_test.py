...
IMAGENET_TEST_CACHE_DIR = _PROJECT_ROOT / "data" / "ImageNet" / "test_cache_256_mmap"
OUTPUT_DIR = Path("eval_outputs_cache")

CHECKPOINT_PATHS = [
    str(_PROJECT_ROOT / "data" / "models" / "unet_colorizer_best.pt"),
    str(_PROJECT_ROOT / "data" / "models" / "unet_colorizer_last.pt"),
    str(_PROJECT_ROOT / "data" / "models" / "unet_colorizer.pt"),
]
BASE_CH = 32
